...
- [应用上下文](../应用开发/应用上下文/README.md) 
  - [参数配置](../应用开发/应用上下文/参数配置.md) 
  - [生命周期](../应用开发/应用上下文/生命周期.md) 
  - [配置文件](../应用开发/应用上下文/配置文件.md) 
...
- [背景特性](../应用开发/背景特性/README.md) 
  - [Spring Integration](../应用开发/背景特性/Spring Integration.md) 
  - [Spring Messaging](../应用开发/背景特性/Spring Messaging.md) 
...
- [Spring Cloud](../微服务/Spring Cloud/README.md) 
  - [Spring Cloud Config](../微服务/Spring Cloud/Spring Cloud Config.md) 
